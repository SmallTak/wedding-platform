...
public class CustomerFeedbackController {
    ...
    public FeedbackDtos.FeedbackPage feedback(
        ...
        return feedbackService.customerFeedback(userId(jwt), page, size, reviewStatus, publishStatus);
    }

    @GetMapping("/options")
    public FeedbackDtos.CustomerFeedbackOptions options(@AuthenticationPrincipal Jwt jwt) {
        return feedbackService.customerOptions(userId(jwt));
    }
    ...
    public FeedbackDtos.FeedbackResponse create(
            @AuthenticationPrincipal Jwt jwt,
            @Valid @RequestBody FeedbackDtos.CustomerFeedbackRequest request,
            HttpServletRequest servletRequest
    ) {
        return feedbackService.createByCustomer(userId(jwt), request, clientIp(servletRequest));
    }
    ...
    public FeedbackDtos.FeedbackResponse update(
        ...
        return feedbackService.updateByCustomer(
                userId(jwt),
                feedbackId,
                request,
