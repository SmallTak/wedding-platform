...
public class CustomerNotificationController {
    ...
    public CustomerNotificationController(UserNotificationService notificationService) {
    ...
    public UserNotificationDtos.NotificationPage notifications(
        ...
        return notificationService.customerNotifications(userId(jwt), page, size, unreadOnly);
    }

    @GetMapping("/unread-count")
    public UserNotificationDtos.UnreadCountResponse unreadCount(@AuthenticationPrincipal Jwt jwt) {
        return notificationService.customerUnreadCount(userId(jwt));
    }
    ...
    public UserNotificationDtos.NotificationResponse markRead(
        ...
        return notificationService.markCustomerRead(userId(jwt), notificationId, request);
    }

    @PostMapping("/read-all")
    public UserNotificationDtos.MarkAllReadResponse markAllRead(@AuthenticationPrincipal Jwt jwt) {
        return notificationService.markAllCustomerRead(userId(jwt));
    }
