...
const navItems = [
  { label: '工作台', href: '#overview', icon: LayoutDashboard },
  { label: '婚礼项目', href: '#projects', icon: FolderHeart },
  { label: '作品集', href: '#projects', icon: Images },
  { label: '审核中心', href: '#review', icon: ShieldCheck },
  { label: '创作者', href: '#creators', icon: UsersRound },
  { label: '分类标签', href: '#categories', icon: Tags },
  { label: '客户反馈', href: '#messages', icon: MessageSquareText },
  { label: '数据统计', href: '#overview', icon: BarChart3 },
]
...
<template>
  <div class="console-shell">
    <aside class="sidebar">
      <a class="console-brand" href="#overview">
        <span>WA</span>
    ...
    <div class="console-main">
      <header class="console-header">
        ...
        <div class="console-actions">
          ...
          <button class="header-icon" type="button" aria-label="站内消息">
            <Bell :size="19" />
            <i></i>
          </button>
        </div>
      ...
      <main class="dashboard-content">
        ...
        <section id="review" class="dashboard-section">
          <div class="section-title-row">
            ...
            <a href="#review" class="section-action">
              进入审核队列
          ...
          <div class="review-table">
            ...
            <article v-for="item in reviewItems" :key="item.title" class="review-row">
              ...
              <span
                :class="[
                  'status-tag',
                  item.status === '部分驳回' ? 'status-rejected' : 'status-pending',
                ]"
              >
              ...
              <a href="#review" class="row-action" aria-label="查看审核详情">
        ...
        <section id="projects" class="dashboard-section">
          ...
          <div class="project-list">
            <article v-for="project in projects" :key="project.name" class="project-row">
              ...
              <div class="progress-track" aria-label="项目完成度">
        ...
        <section id="creators" class="dashboard-split">
          ...
          <div id="messages" class="dashboard-section compact-section">
            <div class="section-title-row">
              <div>
                <p>Messages</p>
                <h2>最新动态</h2>
