  ...
  <div class="site-shell project-detail-page">
    ...
    <main v-else-if="project">
      <section
        ...
        :style="{
          backgroundImage: `url(${project.coverPreviewUrl || project.coverThumbnailUrl || project.coverOriginalUrl || heroImage})`,
        }"
      >
        ...
        <div v-if="collections.length" class="work-grid">
          ...
          >
            <div
              class="work-image"
              :style="{
                backgroundImage: `url(${collection.coverThumbnailUrl || collection.coverPreviewUrl || collection.coverOriginalUrl || heroImage})`,
              }"
            ></div>
            <div class="work-meta">
              <div>
